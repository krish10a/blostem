    ...
    <div className="mouse-glow reveal haptic-hover group relative flex flex-col overflow-hidden rounded-xl border border-outline-variant/10 bg-surface-container-low/60 p-8 shadow-xl shadow-black/20 backdrop-blur-sm transition-all duration-500 hover:-translate-y-1 hover:border-outline-variant/30 hover:bg-surface-container/80">
      ...
      {props.disabled ? (
        ...
        <Link
          ...
          className={
            props.primary
              ? "relative z-10 mt-auto inline-flex w-full items-center justify-center gap-2 rounded-lg bg-gradient-to-r from-primary to-primary-container py-3 font-label font-semibold text-white shadow-[0_8px_24px_rgba(17,101,231,0.3)] transition-all duration-300 hover:brightness-110 hover:shadow-[0_12px_32px_rgba(17,101,231,0.4)] hover:scale-[1.02] active:scale-[0.98]"
              : "relative z-10 mt-auto inline-flex w-full items-center justify-center gap-2 rounded-lg border border-white/10 bg-surface-variant/80 py-3 font-label font-medium text-white transition-all duration-300 hover:bg-surface-bright hover:shadow-lg hover:shadow-black/40 hover:scale-[1.02] active:scale-[0.98]"
          }
        >
