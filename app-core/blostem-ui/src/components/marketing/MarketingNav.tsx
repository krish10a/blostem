...
export function MarketingNav({
  ...
  return (
    <div className="fixed inset-x-0 top-0 z-50 px-3 pt-3 sm:px-4 sm:pt-4 lg:px-6">
      <m.nav
        className="glass-nav mx-auto max-w-screen-2xl rounded-[28px] px-4 py-3 sm:px-5 lg:px-6 will-change-transform transform-gpu"
      ...
      >
        <div className="flex items-center justify-between gap-4">
          <div className="flex items-center gap-3 sm:gap-8">
            <m.div whileHover={reduceMotion ? undefined : { y: -2, scale: 1.01 }}>
              <Link
              href="/"
              className="group flex items-center gap-3 text-slate-100 transition-colors hover:text-white"
            >
              <m.span
                className="flex h-10 w-10 items-center justify-center rounded-2xl bg-gradient-to-br from-primary via-primary-container to-secondary shadow-[0_0_20px_rgba(177,197,255,0.24)] transition-transform duration-500 will-change-transform"
